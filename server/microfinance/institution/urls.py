...
from institution.views import (CustomUserCreateView, CustomUserDetailsView, CustomTokenObtainPairView,
...
] + static(settings.STATIC_URL, document_root=settings.STATIC_ROOT)  # Static Files Image serving
