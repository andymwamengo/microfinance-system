...
from institution.managers import UserManager
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    mfi_service = models.CharField(_('mfi service'), max_length=30, null=False, blank=False)
    mfi_assets = models.CharField(_('mfi assets'), max_length=30, null=False, blank=False)
    mfi_liability = models.CharField(_('mfi liability'), max_length=30, null=False, blank=False)
    mfi_technology = models.CharField(_('mfi technology'), max_length=30, null=False, blank=False)
...
class MfiStakeholder(models.Model):
    ...
    stake_email = models.CharField(_('stakeholder email'), max_length=30, null=True, blank=True)
...
class MfiBoard(models.Model):
    ...
    board_email = models.CharField(_('board email'), max_length=30, null=True, blank=True)
...
class MfiAddress(models.Model):
    ...
    addres_phone_number = models.CharField(_('address phone number'), max_length=30, null=True, blank=True)
    address_website = models.CharField(_('address website'), max_length=30, null=True, blank=True)
...
class UserFeedback(models.Model):
    user_email = models.CharField(_('user email'), max_length=30, null=True, blank=True)
...
class IcomePrediction(models.Model):
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='mfi_predicts', on_delete=models.CASCADE)
    input_age = models.CharField(max_length=10, null=False, blank=False)
    input_fast = models.CharField(max_length=10, null=False, blank=False)
    input_pp = models.CharField(max_length=10, null=False, blank=False)
    input_r = models.CharField(max_length=10, null=False, blank=False)
    input_f = models.CharField(max_length=10, null=False, blank=False)
    input_hbA1c = models.CharField(max_length=10, null=False, blank=False)
