# Generated by Django 3.0.8 on 2020-08-19 23:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mfi_type', models.CharField(choices=[('admin', 'admin'), ('bank', 'bank'), ('private', 'private'), ('saccoss', 'saccoss'), ('vicoba', 'vicoba')], max_length=20, verbose_name='mfi type')),
                ...
                ('mfi_service', models.CharField(max_length=200, verbose_name='mfi service')),
                ('mfi_assets', models.CharField(max_length=30, verbose_name='mfi assets')),
                ('mfi_liability', models.CharField(max_length=200, verbose_name='mfi liability')),
                ('mfi_technology', models.CharField(max_length=200, verbose_name='mfi technology')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_email', models.EmailField(blank=True, max_length=30, null=True, verbose_name='user email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stake_email', models.EmailField(blank=True, max_length=30, null=True, verbose_name='stakeholder email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_dividend', models.CharField(blank=True, default=0, max_length=30, null=True, verbose_name='report dividend')),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='date joined')),
                ('date_updated', models.DateTimeField(auto_now=True, verbose_name='date updated')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_email', models.EmailField(blank=True, max_length=30, null=True, verbose_name='board email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_phone_number', models.CharField(blank=True, max_length=30, null=True, verbose_name='address phone number')),
                ('address_website', models.URLField(blank=True, max_length=30, null=True, verbose_name='address website')),
